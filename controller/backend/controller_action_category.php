<?php 
	class controller_action_category{
		public $model;
		public function __construct(){
			...
			switch($act){
				case "edit":
					$form_action = "admin.php?controller=action_category&act=do_edit&id=$id";
				...
				break;
				case "add":
					$form_action = "admin.php?controller=action_category&act=do_add";
				break;
				case "do_add":
					$c_fullname = $_POST["c_fullname"];
			...
			//-------------
			//load view
			include "view/backend/view_action_category.php";
		}
	}
	new controller_action_category();
 ?>