<?php 
	class controller_category_product{
		...
		public function __construct(){
			...
			$total = $this->model->get_num_rows("select * from tbl_category_product");
			//tinh so trang
			...
			//lay cac ban ghi
			$arr = $this->model->get_all("select * from tbl_category_product order by c_name desc limit $from,$record_perpage");
			//---------
			//load view
