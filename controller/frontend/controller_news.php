 ...
 <?php 
	class controller_news{
		...
		public function __construct(){
			...
			//lay cac ban ghi
			$arr = $this->model->get_all("select tbl_news.*, tbl_category_news.c_name as cate_name from tbl_news LEFT JOIN tbl_category_news ON tbl_news.fk_category_news_id = tbl_category_news.pk_category_news_id order by tbl_news.pk_news_id desc limit $from,$record_perpage");
			//---------
			//load view
