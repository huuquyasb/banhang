...
<div class="breadcrumbs">
    <div class="container">
        <div class="row" <span=""><span><a href="/">Trang chủ</a> » <span class="breadcrumb_last"><?php echo (isset($category) && $category->c_name) ? $category->c_name :'Tất cả sản phẩm';?></span></span>
        </div>
    </div>
</div>
                ...
                <main id="main" class="site-main" role="main">
                    ...
                    <header class="woocommerce-products-header">
                        ...
                        <div class="term-description">
                            <p><span style="font-size: 18pt; color: #ff4081;"><?php echo (isset($category) && $category->c_name) ? $category->c_name : 'Tất cả sản phẩm';?> </span></p>
                    ...
                    <div class="wp-pagenavi">
                        ...
                        ?>
                         <li><a class="page-numbers" href="index.php?controller=product&id=<?php echo $id; ?>&p=<?php echo $i; ?>"><?php  echo $i; ?></a></li>
                        <?php
                        } ?>
