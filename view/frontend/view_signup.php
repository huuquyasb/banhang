                                    ...
                                    <div role="form" class="wpcf7" id="wpcf7-f6-p15-o1" lang="vi" dir="ltr">
                                        <div class="screen-reader-response"></div>
                                            ...
                                            <div class="form-lienhe">
                                                ...
                                                <p><span class="wpcf7-form-control-wrap text-244"><input type="text" name="fullname" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Họ và tên" required/></span></p>
                                                ...
                                                <p><span class="wpcf7-form-control-wrap text-244"><input type="password" name="confirm_password" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Xác nhận mật khẩu" required/></span></p>
